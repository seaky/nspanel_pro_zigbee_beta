...
const boschExtend = {
    hvacThermostatCluster: () => (0, modernExtend_1.deviceAddCustomCluster)('hvacThermostat', {
    ...
    hvacUserInterfaceCfgCluster: () => (0, modernExtend_1.deviceAddCustomCluster)('hvacUserInterfaceCfg', {
    ...
    operatingMode: () => (0, modernExtend_1.enumLookup)({
        name: 'operating_mode',
    ...
    windowDetection: () => (0, modernExtend_1.binary)({
    ...
    boostHeating: () => (0, modernExtend_1.binary)({
        name: 'boost_heating',
        cluster: 'hvacThermostat',
    ...
    childLock: () => (0, modernExtend_1.binary)({
        name: 'child_lock',
    ...
    displayOntime: () => (0, modernExtend_1.numeric)({
        name: 'display_ontime',
        cluster: 'hvacUserInterfaceCfg',
    ...
    displayBrightness: () => (0, modernExtend_1.numeric)({
        ...
        const fromZigbee = [
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    if (msg.data.zoneStatus !== undefined || msg.data.zonestatus !== undefined) {
                        ...
                        const lookup = { 0x00: 'none', 0x01: 'single', 0x02: 'long' };
                        const result = {
...
const definitions = [
    {
        ...
        extend: [
            (0, modernExtend_1.deviceAddCustomCluster)('ssIasZone', {
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('ssIasWd', {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceAddCustomCluster)('twinguardSmokeDetector', {
                ID: 0xe000,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('twinguardMeasurements', {
                ID: 0xe002,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
                    ...
                    illuminance_lux: { ID: 0x4005, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('twinguardOptions', {
                ID: 0xe004,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('twinguardSetup', {
                ID: 0xe006,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
            ...
            (0, modernExtend_1.deviceAddCustomCluster)('twinguardAlarm', {
                ID: 0xe007,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)(), (0, modernExtend_1.electricityMeter)(), (0, modernExtend_1.ota)()],
        whiteLabel: [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.identify)(), (0, modernExtend_1.light)({ configureReporting: true, effect: false })],
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { left: 2, right: 3 } }),
            (0, modernExtend_1.deviceAddCustomCluster)('boschSpecific', {
                ID: 0xfca0,
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
