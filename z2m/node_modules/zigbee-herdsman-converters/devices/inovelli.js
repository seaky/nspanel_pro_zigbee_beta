...
const inovelliExtend = {
    addCustomClusterInovelli: () => (0, modernExtend_1.deviceAddCustomCluster)('manuSpecificInovelli', {
        ID: 64561,
        manufacturerCode: 0x122f,
        attributes: {
            dimmingSpeedUpRemote: { ID: 0x001, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            leadingTrailingEdge: { ID: 0x001a, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
...
const tzLocal = {
    ...
    light_onoff_brightness_inovelli: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            let state = message.state !== undefined
                ? // @ts-expect-error ignore
...
const definitions = [
    ...
    },
    {
        ...
        exposes: exposesListVZM35.concat((0, modernExtend_1.identify)().exposes),
        extend: [inovelliExtend.addCustomClusterInovelli()],
        ota: ota.inovelli,
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        exposes: exposesListVZM36.concat((0, modernExtend_1.identify)().exposes),
        extend: [inovelliExtend.addCustomClusterInovelli()],
        ota: ota.inovelli,
