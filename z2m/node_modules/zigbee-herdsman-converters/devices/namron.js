...
const definitions = [
    ...
    },
    {
        ...
        vendor: 'Namron',
        description: 'Zigbee LED dimmer',
        extend: [(0, modernExtend_1.light)({ effect: false, configureReporting: true }), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Mains (single phase)' })],
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ effect: false, configureReporting: true, colorTemp: { range: [250, 65279] } })],
    },
    {
        zigbeeModel: ['4512733'],
        model: '4512733',
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: undefined }, color: true, turnsOffAtBrightness1: true })],
    },
    {
        zigbeeModel: ['3802963'],
        model: '3802963',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_contact_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ias_contact_alarm_1_report],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.illuminance],
        toZigbee: [],
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.light)({ effect: false, configureReporting: true, powerOnBehavior: false }),
            (0, modernExtend_1.electricityMeter)({ voltage: false, current: false, configureReporting: true }),
        ],
        meta: {},
    },
];
