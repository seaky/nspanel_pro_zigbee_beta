...
const definitions = [
    {
        ...
        extend: [(0, modernExtend_1.light)({ powerOnBehavior: false, colorTemp: { range: [153, 370], startup: false } })],
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [166, 370] } })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 2, l3: 3 } }), (0, modernExtend_1.onOff)({ endpointNames: ['l1', 'l2', 'l3'], configureReporting: false })],
    },
    {
    ...
    },
    {
        ...
        vendor: 'ORVIBO',
        description: 'Temperature & humidity sensor',
        extend: [(0, modernExtend_1.battery)(), (0, modernExtend_1.humidity)(), (0, modernExtend_1.temperature)()],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { top: 1, bottom: 2 } }), (0, modernExtend_1.onOff)({ endpointNames: ['top', 'bottom'] })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 2, l4: 3, l5: 5, l6: 6 } }), (0, modernExtend_1.onOff)({ endpointNames: ['l1', 'l2', 'l4', 'l5', 'l6'] })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.light)({ colorTemp: { range: [153, 371] } })],
    },
    {
