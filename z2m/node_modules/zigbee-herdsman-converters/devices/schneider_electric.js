...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 10, l2: 11 } }), (0, modernExtend_1.light)({ endpointNames: ['l1', 'l2'], configureReporting: true })],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ powerOnBehavior: true }), (0, modernExtend_1.electricityMeter)({ cluster: 'metering' }), (0, modernExtend_1.identify)()],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 10, l2: 11 } }), (0, modernExtend_1.onOff)({ endpointNames: ['l1', 'l2'] })],
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { left: 4, right: 3, left_btn: 22, right_btn: 21 } }),
            (0, modernExtend_1.light)({ endpointNames: ['left', 'right'], configureReporting: true }),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.schneider_lighting_ballast_configuration, fromZigbee_1.default.command_recall, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop],
        toZigbee: [toZigbee_1.default.ballast_config, toZigbee_1.default.schneider_dimmer_mode],
        endpoint: (device) => {
            return { l1: 3, s1: 21, s2: 22, s3: 23, s4: 24 };
        },
        meta: { multiEndpoint: true },
        extend: [(0, modernExtend_1.light)({ endpointNames: ['l1'], configureReporting: true, levelConfig: {} })],
        exposes: [
            e
                .numeric('ballast_minimum_level', ea.ALL)
                .withValueMin(1)
    ...
    },
    {
        ...
        toZigbee: [
            toZigbee_1.default.schneider_temperature_measured_value,
            ...
            toZigbee_1.default.schneider_pilot_mode,
            toZigbee_1.default.schneider_temperature_measured_value,
        ],
        exposes: [
            e.power(),
    ...
    },
    {
        ...
        toZigbee: [
            toZigbee_1.default.schneider_thermostat_system_mode,
            toZigbee_1.default.schneider_thermostat_occupied_heating_setpoint,
            toZigbee_1.default.schneider_thermostat_control_sequence_of_operation,
            toZigbee_1.default.schneider_thermostat_pi_heating_demand,
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.hvac_user_interface,
            fromZigbee_1.default.wiser_smart_thermostat,
            fromZigbee_1.default.wiser_smart_thermostat_client,
            fromZigbee_1.default.wiser_smart_setpoint_command_client,
        ],
        toZigbee: [
            toZigbee_1.default.wiser_sed_thermostat_local_temperature_calibration,
            toZigbee_1.default.wiser_sed_occupied_heating_setpoint,
            toZigbee_1.default.wiser_sed_thermostat_keypad_lockout,
            toZigbee_1.default.wiser_vact_calibrate_valve,
            toZigbee_1.default.wiser_sed_zone_mode,
        ],
        exposes: [
            e.battery(),
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.wiser_smart_thermostat_client,
            fromZigbee_1.default.wiser_smart_setpoint_command_client,
            fromZigbee_1.default.schneider_temperature,
        ],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_genOta, fromZigbee_1.default.ignore_zclversion_read, fromZigbee_1.default.wiser_smart_thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.identify],
        toZigbee: [
            toZigbee_1.default.thermostat_local_temperature,
            toZigbee_1.default.thermostat_occupied_heating_setpoint,
            toZigbee_1.default.wiser_fip_setting,
            toZigbee_1.default.wiser_hact_config,
            toZigbee_1.default.wiser_zone_mode,
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { right: 21, left: 22 } }),
            switchActions('right'),
            switchActions('left'),
            (0, modernExtend_1.commandsOnOff)({ endpointNames: ['right', 'left'] }),
            (0, modernExtend_1.commandsLevelCtrl)({ endpointNames: ['right', 'left'] }),
        ],
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ powerOnBehavior: true }), (0, modernExtend_1.electricityMeter)()],
    },
    {
    ...
    },
    {
        ...
        vendor: 'Schneider Electric',
        description: 'Smart thermostat',
        fromZigbee: [fromZigbee_1.default.stelpro_thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.schneider_pilot_mode, fromZigbee_1.default.wiser_device_info, fromZigbee_1.default.hvac_user_interface, fromZigbee_1.default.temperature],
        toZigbee: [
            toZigbee_1.default.thermostat_occupied_heating_setpoint,
            toZigbee_1.default.thermostat_system_mode,
            toZigbee_1.default.thermostat_running_state,
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { left: 1, right: 2, left_sw: 21, right_sw: 22 } }),
            (0, modernExtend_1.identify)(),
            (0, modernExtend_1.onOff)({ powerOnBehavior: false, endpointNames: ['left', 'right'] }),
            (0, modernExtend_1.commandsOnOff)({ endpointNames: ['left_sw', 'right_sw'] }),
        ],
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { left: 1, right: 2, left_sw: 21 } }),
            (0, modernExtend_1.identify)(),
            (0, modernExtend_1.onOff)({ powerOnBehavior: false, endpointNames: ['left', 'right'] }),
            (0, modernExtend_1.commandsOnOff)({ endpointNames: ['left_sw'] }),
        ],
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { switch: 1, switch_sw: 21 } }),
            (0, modernExtend_1.identify)(),
            (0, modernExtend_1.onOff)({ powerOnBehavior: false }),
            (0, modernExtend_1.commandsOnOff)({ endpointNames: ['switch_sw'] }),
        ],
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 10 } }),
            (0, modernExtend_1.onOff)({ endpointNames: ['l1'], powerOnBehavior: false }),
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 10, l2: 11 } }),
            (0, modernExtend_1.onOff)({ endpointNames: ['l1', 'l2'], powerOnBehavior: false }),
            schneiderElectricExtend.addVisaConfigurationCluster(zigbee_herdsman_1.Zcl.DataType.UINT8),
            schneiderElectricExtend.visaConfigIndicatorLuminanceLevel(),
            schneiderElectricExtend.visaConfigIndicatorColor(),
            schneiderElectricExtend.visaIndicatorMode([0, 1, 2, 3]),
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 10, l2: 11, l3: 12 } }),
