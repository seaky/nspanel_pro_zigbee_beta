...
const definitions = [
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.onOff)({ endpointNames: ['1'], description: 'Controls the USB port' }),
            (0, modernExtend_1.onOff)({ powerOnBehavior: false, endpointNames: ['2'], description: 'LED indicates the Zigbee status' }),
            (0, modernExtend_1.onOff)({ powerOnBehavior: false, endpointNames: ['3'], description: 'LED indicates the USB state' }),
            (0, modernExtend_1.iasZoneAlarm)({ zoneType: 'generic', zoneAttributes: ['alarm_1'], description: 'Over current alarm' }),
        ],
        meta: { multiEndpoint: true },
    },
];
