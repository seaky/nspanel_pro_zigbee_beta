...
const extend = {
    comfortDisplay: (0, modernExtend_1.binary)({
    ...
    comfortHumidityMax: (0, modernExtend_1.numeric)({
    ...
    comfortHumidityMin: (0, modernExtend_1.numeric)({
    ...
    comfortTemperatureMin: (0, modernExtend_1.numeric)({
    ...
    comfortTemperatureMax: (0, modernExtend_1.numeric)({
    ...
    display: (0, modernExtend_1.binary)({
        name: 'display',
        valueOn: ['on', 0],
        valueOff: ['off', 1],
        cluster: 'hvacUserInterfaceCfg',
    ...
    endpointQuirk: (0, modernExtend_1.quirkAddEndpointCluster)({
        endpointID: 1,
    ...
    humidityCalibration: (0, modernExtend_1.numeric)({
    ...
    measurementInterval: (0, modernExtend_1.numeric)({
    ...
    tempCalibration: (0, modernExtend_1.numeric)({
    ...
    tempDisplayMode: (0, modernExtend_1.enumLookup)({
