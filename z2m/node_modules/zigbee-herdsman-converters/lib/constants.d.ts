...
export declare const thermostatControlSequenceOfOperations: KeyValueNumberString;
export declare const thermostatProgrammingOperationModes: KeyValueNumberString;
export declare const thermostatSystemModes: KeyValueNumberString;
export declare const acovaThermostatSystemModes: KeyValueNumberString;
export declare const thermostatRunningMode: KeyValueNumberString;
export declare const thermostatDayOfWeek: KeyValueNumberString;
export declare const thermostatRunningStates: KeyValueAny;
export declare const thermostatAcLouverPositions: KeyValueNumberString;
export declare const thermostatScheduleMode: KeyValueNumberString;
