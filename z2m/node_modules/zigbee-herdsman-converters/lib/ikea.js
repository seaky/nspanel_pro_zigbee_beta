...
function ikeaLight(args) {
    ...
    const result = (0, modernExtend_1.light)({ ...args, colorTemp });
...
function ikeaBattery() {
    ...
    const configure = [(0, modernExtend_1.setupConfigureForReporting)('genPowerCfg', 'batteryPercentageRemaining', defaultReporting, exposes_1.access.STATE_GET)];
