...
exports.philipsFz = exports.tz = exports.philipsTz = void 0;
exports.philipsLight = philipsLight;
exports.philipsOnOff = philipsOnOff;
exports.philipsTwilightOnOff = philipsTwilightOnOff;
...
function philipsLight(args) {
    ...
    result.toZigbee.push(exports.philipsTz.hue_power_on_behavior, exports.philipsTz.hue_power_on_error);
    if (args.hueEffect || args.gradient) {
        result.toZigbee.push(exports.philipsTz.effect);
        const effects = ['blink', 'breathe', 'okay', 'channel_change', 'candle'];
        if (args.color)
            effects.push('fireplace', 'colorloop');
        if (args.gradient) {
            result.toZigbee.push(exports.philipsTz.gradient_scene, exports.philipsTz.gradient({ reverse: true }));
            result.fromZigbee.push(exports.philipsFz.gradient);
            ...
            ...(0, utils_1.exposeEndpoints)(e.enum('gradient_scene', ea.SET, Object.keys(gradientScenes)), args.endpointNames), ...(0, utils_1.exposeEndpoints)(e
...
function philipsOnOff(args) {
    args = { powerOnBehavior: false, ota: ota.zigbeeOTA, ...args };
    const result = modernExtend.onOff(args);
    result.toZigbee.push(exports.philipsTz.hue_power_on_behavior, exports.philipsTz.hue_power_on_error);
    return result;
}
function philipsTwilightOnOff() {
    const fromZigbee = [fromZigbee_1.default.ignore_command_on, fromZigbee_1.default.ignore_command_off, fromZigbee_1.default.hue_twilight];
    const exposes = [
        e.action([
            'dot_press',
            'dot_hold',
