...
class AdapterBackup {
    ...
    async createBackup(ieeeAddressesInDatabase) {
            ...
            devices: (addressManagerTable &&
                addressManagerTable.used
                    ...
                    if (sme) {
                        ...
                        if (tclkTableEntry) {
                            (0, assert_1.default)(tclkSeed, 'Cannot be undefined because this is only called for ZStack 3');
        ...
        try {
            ...
            (0, assert_1.default)(oldBackup, "Old backup doesn't exist");
            ...
            logger_1.logger.debug(`Following devices with link key are missing from new backup but present in old backup and database, ` +
                `adding them back: ${missingStr}`, NS);
        ...
        for (const device of backup.devices) {
            ...
            if (device.linkKey) {
                ...
                if (!linkKeyProcessed) {
                    ...
                    (0, assert_1.default)(ameIndex != null);
                    sme.ami = ameIndex;
                    const apsKeyDataEntryIndex = apsLinkKeyDataTable.indexOf(apsKeyDataEntry);
                    (0, assert_1.default)(apsKeyDataEntryIndex != null);
