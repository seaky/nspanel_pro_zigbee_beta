...
class ZnpAdapterManager {
            ...
            if (configMatchesAdapter) {
                ...
                if (backup) {
                    ...
                    if (backupMatchesAdapter) {
                        ...
                        logger_1.logger.error(`- Network Key: configured=${this.nwkOptions.networkKey.toString('hex')}, adapter=${activeKeyInfo.key.toString('hex')}`, NS);
    ...
    async beginStartup() {
        ...
        if (deviceInfo.payload.devicestate !== common_1.DevStates.ZB_COORD) {
            ...
            await this.znp.request(constants_1.Subsystem.ZDO, 'startupFromApp', { startdelay: 100 }, null, null, [
