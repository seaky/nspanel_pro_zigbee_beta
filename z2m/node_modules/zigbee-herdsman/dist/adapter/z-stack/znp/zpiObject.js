...
const BufferAndListTypes = [
    ...
    parameterType_1.default.LIST_ROUTING_TABLE,
    parameterType_1.default.LIST_BIND_TABLE,
    parameterType_1.default.LIST_NEIGHBOR_LQI,
    parameterType_1.default.LIST_NETWORK,
    parameterType_1.default.LIST_ASSOC_DEV,
...
class ZpiObject {
    ...
    isResetCommand() {
        return ((this.command === 'resetReq' && this.subsystem === constants_1.Subsystem.SYS) || (this.command === 'systemReset' && this.subsystem === constants_1.Subsystem.SAPI));
    }
}
