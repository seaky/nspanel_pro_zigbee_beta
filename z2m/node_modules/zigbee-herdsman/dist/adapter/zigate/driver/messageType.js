...
exports.ZiGateMessage = {
    ...
    [constants_1.ZiGateMessageCode.Status]: {
        response: [
            ...
            { name: 'packetType', parameterType: parameterType_1.default.UINT16BE }, // <Packet Type: uint16_t>
            // from 3.1d
    ...
    [constants_1.ZiGateMessageCode.APSDataACK]: {
        response: [
            ...
            // // <destination address mode: uint8_t>
            { name: 'destinationAddress', parameterType: parameterType_1.default.UINT16BE },
            { name: 'destinationEndpoint', parameterType: parameterType_1.default.UINT8 }, // <destination endpoint: uint8_t>
            { name: 'clusterID', parameterType: parameterType_1.default.UINT16BE },
            // // <destination address: uint16_t or uint64_t>
    ...
    [constants_1.ZiGateMessageCode.NetworkState]: {
        response: [
            { name: 'shortAddress', parameterType: parameterType_1.default.UINT16BE }, // <Short Address: uint16_t>
            { name: 'extendedAddress', parameterType: parameterType_1.default.IEEEADDR }, // <Extended Address: uint64_t>
            { name: 'PANID', parameterType: parameterType_1.default.UINT16BE }, // <PAN ID: uint16_t>
    ...
    [constants_1.ZiGateMessageCode.ManagementLeaveResponse]: {
        response: [
            { name: 'sqn', parameterType: parameterType_1.default.UINT8 },
            { name: 'status', parameterType: parameterType_1.default.UINT8 }, // <status: uint8_t>
        ],
    },
    ...
    [constants_1.ZiGateMessageCode.SimpleDescriptorResponse]: {
        response: [
            { name: 'sourceEndpoint', parameterType: parameterType_1.default.UINT8 }, //<source endpoint: uint8_t>
            { name: 'profile ID', parameterType: parameterType_1.default.UINT16BE }, // <profile ID: uint16_t>
            { name: 'clusterID', parameterType: parameterType_1.default.UINT16BE }, // <cluster ID: uint16_t>
            { name: 'attributeList', parameterType: parameterType_1.default.LIST_UINT16BE }, // <attribute list: data each entry is uint16_t>
        ],
    },
    [constants_1.ZiGateMessageCode.ManagementLQIResponse]: {
        response: [
            { name: 'sequence', parameterType: parameterType_1.default.UINT8 }, // <Sequence number: uint8_t>
            { name: 'status', parameterType: parameterType_1.default.UINT8 }, // <status: uint8_t>
            { name: 'neighbourTableEntries', parameterType: parameterType_1.default.UINT8 }, // <Neighbour Table Entries : uint8_t>
            { name: 'neighbourTableListCount', parameterType: parameterType_1.default.UINT8 }, // <Neighbour Table List Count : uint8_t>
            ...
            { name: 'NWKAddress', parameterType: parameterType_1.default.UINT16BE }, // NWK Address : uint16_t
            { name: 'Extended PAN ID', parameterType: parameterType_1.default.IEEEADDR }, // Extended PAN ID : uint64_t
            { name: 'IEEE Address', parameterType: parameterType_1.default.IEEEADDR }, // IEEE Address : uint64_t
            { name: 'Depth', parameterType: parameterType_1.default.UINT8 }, // Depth : uint_t
            { name: 'linkQuality', parameterType: parameterType_1.default.UINT8 }, // Link Quality : uint8_t
            { name: 'bitMap', parameterType: parameterType_1.default.UINT8 }, // Bit map of attributes Described below: uint8_t
            // bit 0-1 Device Type
            ...
            // (1-On 0-Off)
            { name: 'srcAddress', parameterType: parameterType_1.default.UINT16BE }, // <Src Address : uint16_t> ( only from v3.1a)
        ],
    },
    [constants_1.ZiGateMessageCode.PDMEvent]: {
        response: [
            { name: 'eventStatus', parameterType: parameterType_1.default.UINT8 }, // <event status: uint8_t>
            { name: 'recordID', parameterType: parameterType_1.default.UINT32BE }, // <record ID: uint32_t>
        ],
    },
    ...
    [constants_1.ZiGateMessageCode.AddGroupResponse]: {
        response: [
            { name: 'status', parameterType: parameterType_1.default.UINT16BE },
