...
import { FoundationDefinition } from './definition/foundation';
import { Cluster, ClusterName, Command, CustomClusters } from './definition/tstype';
export declare function getDataTypeClass(dataType: DataType): DataTypeClass;
export declare function getCluster(key: string | number, manufacturerCode: number | null, customClusters: CustomClusters): Cluster;
